...
//! const
const num1 = 19; //! literal type: A variable created using  const keyword in TypeScript the value itself will become the type it is known as literal types. It can't be changed later on. The value will be constant here
